      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <div className="inline-block mb-4 fade-in-up-blur">
            <span className="px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-full text-sm font-semibold border border-purple-200 flex items-center gap-2 w-fit mx-auto">
