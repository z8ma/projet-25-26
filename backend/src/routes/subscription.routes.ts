...
// Public route — no auth required to browse plans (pricing page)
...
// Upgrade / downgrade to another plan
router.post('/upgrade', subscriptionController.upgradeSubscription.bind(subscriptionController));
